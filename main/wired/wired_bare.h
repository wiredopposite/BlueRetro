...
#elif defined(CONFIG_BLUERETRO_SYSTEM_GENERIC_I2C)
#define HARDCODED_SYS GENERIC_I2C
#elif defined(CONFIG_BLUERETRO_SYSTEM_GENERIC_SPI)
#define HARDCODED_SYS GENERIC_SPI
